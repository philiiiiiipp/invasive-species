...
# ============================ PARAMETERS =====================================
            ...
            reachArrivalRates = array([[718, 818], [595, 342], [659, 186], [408, 592], [747, 458], [875, 671], [221, 345]])
            #reachArrivalProbs = array([[random.random() for i in xrange(2)] for i in xrange(nbrReaches)])
            reachArrivalProbs = array([[ 0.62920654,  0.7858338 ], [ 0.70960379,  0.60027096], [ 0.44258255,  0.03024216], [ 0.85840861,  0.03048955], [ 0.36683029,  0.67278394], [ 0.57153177,  0.89630076], [ 0.64539133,  0.70667334]])
