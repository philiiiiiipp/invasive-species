...
/**
 * Represents main structure of the river, but not its contents as those depend on the observations within a certain
 * state.
 */
public class River {
	...
	/**
	 * Retrieves the base structure of the river, defined as a mapping from parent reach indices to its children.
	 * 
